...
const items_0 = [
    getItem('콘텐츠 관리', 'sub1', <AppstoreAddOutlined />, [
        ...
        getItem('X-ray 콘텐츠 관리', 'g2', <BlockOutlined />, [
            ...
            getItem(<Link to="/contents/synthesis3d">3D AI영상합성</Link>, '15', <FileTextOutlined />)
        ])
    ]),
    ...
    getItem('강사 관리', 'sub2', <AppstoreAddOutlined />, [
        ...
        getItem(<Link to="/statistics/total/Total_Evaluation">종합평가 조회</Link>, '32', <FileTextOutlined />)
    ]),

    getItem('학습/평가 관리', 'sub3', <AppstoreAddOutlined />, [
        ...
        getItem(<Link to="/learning/pinnumber">Pin 관리</Link>, '111', <BlockOutlined />)
    ]),
                ...
                <Stack direction="row" spacing={1} alignItems="center" onClick={DashCalls}>
                    <Link style={{ textDecoration: 'none' }}>
                        <div style={{ textAlign: 'center', fontSize: '23px', paddingBottom: '10px', color: '#7da7cb' }}>
                            KSSA - korea security Specialist Academy
                        </div>
