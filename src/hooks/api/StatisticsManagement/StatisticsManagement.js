...
export const statisticsManagement = createApi({
    ...
    endpoints: (builder) => ({
        ...
        // 통계 > 종합평가 > 종합평가 조회 --> 교육생별 상세 조회
        selectBaselineStudentScore: builder.mutation({
            query: (body) => ({
                url: 'adm/userMgr/selectBaselineStudentScore.do',
                method: 'POST',
                body: body
            })
        })
...
export const {
    ...
    useSelectBaselineStudentScoreMutation
