...
export const KakaoMap = () => {
    ...
    useEffect(() => {
        ...
        const infowindow = new kakao.maps.InfoWindow({
            content:
                '<div style="font-size:15px; height:95px; text-align:center; line-height:30px; width:300px; padding:10px;">' +
    ...
    return (
        ...
        `}
            ...
            <div ref={containerRef} id="container" className="view_map" style={{ width: '100%' }}>
                <div ref={mapWrapperRef} id="mapWrapper" style={{ width: '100%', height: '500px', position: 'relative' }}>
                    <div ref={mapContainerRef} id="map" style={{ width: '100%', height: '100%' }}></div>
                    <input type="button" id="btnRoadview" onClick={() => toggleMap(false)} title="로드뷰 보기" value="로드뷰" />
                </div>
                <div ref={rvWrapperRef} id="rvWrapper" style={{ width: '100%', height: '500px', position: 'absolute', top: 0, left: 0 }}>
